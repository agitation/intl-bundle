...
var
    ...
    getPluralMessageIdx = function(amount)
    {
        if (!pluralCallbacks[curLang])
            pluralCallbacks[curLang] = new Function("n", "return (" +  (ag.intl.plurals[curLang] || ag.intl.plurals._default) + ") | 0"); // jshint ignore:line
...
ag.intl.n = function(msgid, msgidPlural, amount)
{
    ...
    return entry ? entry[getPluralMessageIdx(amount)] : (amount === 1 ? msgid : msgidPlural);
};
